...
def run_network(model=None, data=None):
    ...
    if data is None:
        print('Loading data... ')
        #X_train, y_train, X_test, y_test = lstm.load_data('s0010_re_i.csv',sequence_length,False)
        X_train, y_train, X_test, y_test = get_split_prep_data(0, 10000, 10000, 15000)
    else:
